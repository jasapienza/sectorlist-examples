...
md`The purpose of this demo is to test the geometric correctness of [the Sector List (SL) implementation](https://observablehq.com/@jasapienza/part-1-sector-list-implementation-in-javascript). For this, we compare our SL results with the results of [JSTS](https://github.com/bjornharrtell/jsts), a port in JavaScript language of the well established library [Java Topology Suite (JTS)](https://github.com/locationtech/jts) for creating and manipulating vector geometry.

The following procedure is used to generate the tests:
- Two random polygons are created using the [implementation described in Part 3](https://observablehq.com/@jasapienza/part-4-sector-lists-experiment-2-random-polygons). You can choose below three parameters to change the complexity of the randomized geometry.
