...
**Sector Lists** (SLs) are data structures that represent polygonal scalar fields equivalent to polygonal maps. SLs are elegant and efficient data structures combining properties of representations based both on vertex circulations (polygons) and on rasters (images).
